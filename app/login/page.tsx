  ...
  return (
    <main className="grid min-h-[calc(100vh-73px)] place-items-center px-4 py-10 sm:px-6 lg:px-8">
      <form onSubmit={handleSubmit} className="w-full max-w-md rounded-lg border border-slate-200 bg-white p-6 shadow-soft">
        <div className="mb-6">
          <div className="mb-4 grid h-12 w-12 place-items-center rounded-lg bg-blue-50 text-wiro-700">
            <LogIn className="h-6 w-6" />
          </div>
          <h1 className="text-3xl font-bold text-ink">Panele giriş</h1>
          <p className="mt-2 text-sm leading-6 text-slate-600">
            Üretim araçlarınızı kullanmak için hesabınıza giriş yapın.
          </p>
        </div>
        ...
        <p className="mt-4 text-center text-sm text-slate-600">
          Hesabınız yok mu?{" "}
          <Link href="/register" className="font-bold text-wiro-700">
            Kayıt ol
          </Link>
        </p>
      </form>
